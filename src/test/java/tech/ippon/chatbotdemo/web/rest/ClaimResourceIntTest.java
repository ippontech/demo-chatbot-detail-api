...
public class ClaimResourceIntTest {
    ...
    public void createClaim() throws Exception {
        ...
        assertThat(testClaim.getDamageDescription()).isEqualTo(DEFAULT_DAMAGE_DESCRIPTION);
    }
    ...
    public void getAllClaims() throws Exception {
        ...
        restClaimMockMvc.perform(get("/api/claims?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].damageDescription").value(hasItem(DEFAULT_DAMAGE_DESCRIPTION.toString())));
    }
    ...
    public void getClaim() throws Exception {
        ...
        restClaimMockMvc.perform(get("/api/claims/{id}", claim.getId()))
            ...
            .andExpect(jsonPath("$.damageDescription").value(DEFAULT_DAMAGE_DESCRIPTION.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateClaim() throws Exception {
        ...
        assertThat(testClaim.getDamageDescription()).isEqualTo(UPDATED_DAMAGE_DESCRIPTION);
    }
