...
import org.jhipster.repository.VehicleRepository;
...
public class VehicleResourceIntTest {
    ...
    private static final Boolean DEFAULT_HAS_POLICY = false;
    private static final Boolean UPDATED_HAS_POLICY = true;

    private static final Long DEFAULT_POLICY_NUMBER = 1L;
    private static final Long UPDATED_POLICY_NUMBER = 2L;
    ...
    public void createVehicle() throws Exception {
        ...
        assertThat(testVehicle.isHasPolicy()).isEqualTo(DEFAULT_HAS_POLICY);
        assertThat(testVehicle.getPolicyNumber()).isEqualTo(DEFAULT_POLICY_NUMBER);
    }
    ...
    public void getAllVehicles() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hasPolicy").value(hasItem(DEFAULT_HAS_POLICY.booleanValue())))
            .andExpect(jsonPath("$.[*].policyNumber").value(hasItem(DEFAULT_POLICY_NUMBER.intValue())));
    }
    ...
    public void getVehicle() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles/{id}", vehicle.getId()))
            ...
            .andExpect(jsonPath("$.hasPolicy").value(DEFAULT_HAS_POLICY.booleanValue()))
            .andExpect(jsonPath("$.policyNumber").value(DEFAULT_POLICY_NUMBER.intValue()));
    }
    ...
    public void updateVehicle() throws Exception {
        ...
        assertThat(testVehicle.isHasPolicy()).isEqualTo(UPDATED_HAS_POLICY);
        assertThat(testVehicle.getPolicyNumber()).isEqualTo(UPDATED_POLICY_NUMBER);
    }
